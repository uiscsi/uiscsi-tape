...
// It wraps a [github.com/uiscsi/uiscsi.Session] to speak SSC commands to
// tape drives, handling sense data interpretation, block limits, and drive
// probing.
//
// For data transfer, use [github.com/uiscsi/uiscsi.Session.StreamExecute]
...
// [github.com/uiscsi/uiscsi.ParseSenseData] and wrapped into [TapeError]
